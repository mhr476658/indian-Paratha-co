...
export const RestaurantStory: React.FC = () => {
  return (
    ...
    >
      <div className="absolute top-1/3 left-0 w-96 h-96 bg-[#e41c24]/10 rounded-full blur-[140px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-6 relative">
            <div className="relative rounded-3xl overflow-hidden border border-white/20 shadow-2xl">
              ...
              <div className="absolute bottom-6 left-6 right-6 p-5 rounded-2xl bg-black/85 backdrop-blur-xl border border-white/15 shadow-2xl">
                <div className="flex items-center gap-3">
                  <div className="p-3 rounded-xl bg-[#e41c24] text-white shrink-0 font-bold">
            ...
            <div className="hidden sm:block absolute -top-6 -right-6 p-4 rounded-2xl bg-[#0b192c] border border-white/20 shadow-2xl backdrop-blur-md max-w-[200px] text-center">
              <span className="text-2xl font-sans font-black text-[#e41c24] block">100%</span>
          ...
          <div className="lg:col-span-6 flex flex-col justify-center">
            ...
            <h2 className="font-sans text-3xl sm:text-5xl lg:text-6xl font-bold text-white tracking-tight mb-6 leading-tight">
              A Highway Sanctuary for <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FFFFFF] via-[#F5E6CC] to-[#e41c24]">True Food Lovers</span>
            </h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5 mb-8">
              <div className="p-3.5 rounded-2xl bg-[#0b192c] border border-white/10 flex items-center gap-2.5 text-xs text-white/80">
