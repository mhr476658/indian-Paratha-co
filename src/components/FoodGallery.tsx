      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        {/* Fullscreen Lightbox Modal */}
          {lightboxIndex !== null && typeof document !== 'undefined' && createPortal(
            <div 
              className="fixed inset-0 z-[9999] bg-black/95 backdrop-blur-2xl flex items-center justify-center p-4 sm:p-8 animate-fadeIn"
              onClick={closeLightbox}
            >
              {/* Close Button */}
              <button
                onClick={closeLightbox}
                className="absolute top-4 right-4 sm:top-6 sm:right-6 p-3 sm:p-4 rounded-full bg-white/10 hover:bg-white/20 border border-white/20 text-white backdrop-blur-md transition-colors z-[99999] shadow-2xl cursor-pointer"
              ...
              <button
                ...
                className="absolute left-2 sm:left-8 top-1/2 -translate-y-1/2 p-3 sm:p-4 rounded-full bg-white/10 hover:bg-white/20 border border-white/20 text-white backdrop-blur-md transition-colors z-[99999] cursor-pointer"
              ...
              <button
                ...
                className="absolute right-2 sm:right-8 top-1/2 -translate-y-1/2 p-3 sm:p-4 rounded-full bg-white/10 hover:bg-white/20 border border-white/20 text-white backdrop-blur-md transition-colors z-[99999] cursor-pointer"
              ...
              <div 
                className="max-w-4xl max-h-[85vh] flex flex-col items-center justify-center text-center px-8 sm:px-0 mt-8 sm:mt-0 relative z-[99995]"
