...
export const ChaiExperience: React.FC<ChaiExperienceProps> = ({
  ...
  return (
    <section id="chai" className="py-20 sm:py-28 bg-[#0b192c] text-white relative overflow-hidden border-t border-white/10">
      {/* Warm amber glow background */}
      <div className="absolute -top-10 left-1/2 -translate-x-1/2 w-[700px] h-[500px] bg-[#e41c24]/10 rounded-full blur-[160px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-14 sm:mb-20">
          ...
          <h2 className="font-sans text-3xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-white mb-4">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#0b192c] via-[#F5E6CC] to-[#e41c24]">
              STARTS WITH CHAI.
            </span>
          </h2>
        ...
        <div className="relative max-w-4xl mx-auto mb-16 rounded-3xl overflow-hidden border border-white/15 shadow-2xl bg-[#0b192c]/95 backdrop-blur-xl">
          <div className="grid grid-cols-1 md:grid-cols-12 items-center">
            ...
            <div className="md:col-span-6 relative aspect-square sm:aspect-[4/3] overflow-hidden">
              ...
              <div className="absolute inset-0 pointer-events-none flex justify-center items-center">
                <div className="w-4 h-24 bg-[#0b192c]/20 blur-md rounded-full animate-steam-1 -ml-6 -mt-16" />
                <div className="w-5 h-28 bg-[#0b192c]/25 blur-lg rounded-full animate-steam-2 mt-[-60px]" />
                <div className="w-3 h-20 bg-[#0b192c]/15 blur-sm rounded-full animate-steam-3 ml-8 -mt-20" />
              </div>

              <div className="absolute bottom-4 left-4 bg-black/75 backdrop-blur-md px-3.5 py-1.5 rounded-full border border-white/15 text-xs font-semibold text-[#e41c24] font-mono">
            ...
            <div className="md:col-span-6 p-6 sm:p-10 flex flex-col justify-center">
              <div className="flex items-center gap-2 mb-2">
                <Flame className="w-4 h-4 text-[#e41c24]" />
                <span className="text-xs uppercase font-mono font-bold tracking-widest text-[#e41c24]">
              ...
              <div className="flex items-center justify-between pt-4 border-t border-white/10">
                <span className="font-sans text-3xl font-bold text-[#e41c24]">₹80</span>
                <button
                  id="chai-hero-add-btn"
                  onClick={() => handleAddChai(CHAI_ITEMS[1])}
                  className="px-6 py-2.5 bg-[#0b192c] hover:bg-[#e41c24] text-white text-xs font-bold uppercase tracking-widest rounded-full transition-all shadow-md active:scale-95 cursor-pointer"
                >
                  Order Masala Chai
                </button>
              </div>
          ...
          {CHAI_ITEMS.map((chai) => {
            ...
            return (
              <div
                ...
                className="bg-[#0b192c]/95 border border-white/15 hover:border-[#e41c24]/60 p-5 rounded-3xl flex flex-col justify-between transition-all duration-300 group hover:-translate-y-1 backdrop-blur-xl shadow-xl"
              >
                <div>
                  <div className="flex items-start justify-between gap-3 mb-2">
                    <div>
                      <h4 className="font-sans text-lg font-bold text-white group-hover:text-[#e41c24] transition-colors">
                        {chai.name}
                      </h4>
                    ...
                    <span className="font-sans text-xl font-bold text-[#e41c24]">
                      ₹{chai.price}
                    </span>
                  </div>
                  ...
                  <button
                    ...
                    className={`min-h-[34px] px-3.5 rounded-full text-[11px] font-bold uppercase tracking-wider transition-all duration-200 flex items-center gap-1 active:scale-95 cursor-pointer ${
                      isAdded
                        ...
                        : 'bg-[#0b192c] hover:bg-[#e41c24] text-white shadow-sm'
                    }`}
                  >
                    {isAdded ? (
                      <>
        ...
        <div className="text-center">
          <button
            ...
            className="px-8 py-3.5 bg-[#0b192c]/5 hover:bg-[#0b192c]/10 text-white hover:text-[#e41c24] text-xs font-bold uppercase tracking-[0.25em] rounded-full border border-white/20 hover:border-[#e41c24] transition-all cursor-pointer inline-flex items-center gap-2"
          >
