...
export const Products: React.FC = () => {
  ...
  return (
    <section id="products" className="py-20 sm:py-28 bg-[#0b192c] text-white relative border-t border-white/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 sm:mb-16">
          ...
          <h2 className="font-sans text-3xl sm:text-5xl font-bold text-white tracking-wider mb-4">
            OUR <span className="text-[#e41c24]">PRODUCTS</span>
          </h2>
        ...
        <div className="bg-[#0b192c] rounded-3xl border border-white/10 overflow-hidden max-w-sm mx-auto shadow-2xl flex flex-col items-center">
          ...
          <div className="p-8 w-full text-center flex flex-col items-center">
            ...
            <p className="text-[#e41c24] text-sm font-mono tracking-widest uppercase mb-4">100% Upper Assam Granules</p>
